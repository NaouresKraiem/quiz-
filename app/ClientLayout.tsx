          ...
          {user ?
            <>
              <Link href={'/quizzes/new'}>
                <Button icon={<PlusOutlined />} type="primary" className="h-9 px-5 bg-emerald-500 hover:bg-emerald-400 border-0 rounded-lg font-semibold shadow-md shadow-emerald-500/20 transition-all duration-200"
                >
